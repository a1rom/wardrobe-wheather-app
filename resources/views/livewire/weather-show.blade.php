        ...
        <div class="relative w-full sm:w-3/4 md:w-3/4 lg:w-1/2">
            <input 
                ...
                @class([
                    ...
                    'border-1 border-red-400 rind-red-300 focus:ring-red-300 text-red-600' => $errors->has('locationSearch'),
                ])
                placeholder="Enter your location"
                wire:model.defer="locationSearch"
            >
            @if($errors->has('locationSearch'))
                <p class="absolute left-0 mt-2 pl-3 sm:pl-0 text-sm text-red-600">
